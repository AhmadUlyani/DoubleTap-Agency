...
<section class="about-section">
    <div class="about-container">
        <div class="about-text fade-in">
            ...
            <p>DoubleTap Agency adalah agensi kreatif mikro yang didirikan oleh tim mahasiswa Teknologi Informasi Universitas Lambung Mangkurat. Kami fokus membantu UMKM lokal di sektor F&B dan Fashion naik kelas secara digital.</p>
            <p>Kami tidak sekadar bikin konten yang cantik. Kami menggunakan prinsip <strong>UI/UX</strong> dan <strong>analisis algoritma</strong> untuk memastikan setiap unggahan menjangkau orang yang tepat, pada waktu yang tepat.</p>
...
<section class="portfolio-section" id="portfolio">
    <div class="portfolio-container">
        ...
        <p class="section-sub text-center">Simulasi karya awal DoubleTap Agency untuk menunjukkan arah visual, copywriting, dan laporan insight yang bisa diterima klien.</p>
                ...
                <div class="portfolio-preview <?= htmlspecialchars($item['theme']) ?>">
                    <div class="portfolio-phone">
                        ...
                        <div class="phone-post">
                            <div class="post-visual"><?= $item['icon'] ?></div>
        ...
        <p class="portfolio-note text-center">Catatan: portfolio ini berupa mockup/simulasi untuk kebutuhan presentasi awal. Hasil aktual bergantung pada kondisi akun dan konsistensi konten setiap klien.</p>
    </div>
</section>
    ...
    <div class="pricing-container">
        ...
        <div class="pricing-grid">
            ...
            <div class="pricing-card <?= $svc['highlight'] ? 'pricing-highlight' : '' ?> fade-in">
                ...
                <div class="pc-price"><?= htmlspecialchars($svc['price']) ?><span><?= htmlspecialchars($svc['period']) ?></span></div>
                <ul class="pc-features">
                    <?php foreach ($svc['features'] as $f): ?>
                    <li>✓ <?= htmlspecialchars($f) ?></li>
                    <?php endforeach; ?>
                </ul>
                <a href="<?= url('/contact') ?>?package=<?= $svc['highlight'] ? 'growth' : 'starter' ?>" class="<?= $svc['highlight'] ? 'btn-primary' : 'btn-secondary' ?> btn-full"><?= htmlspecialchars($svc['cta']) ?></a>
            </div>
            <?php endforeach; ?>
        </div>
        <p class="pricing-note text-center">Tidak yakin pilih paket apa? <a href="<?= url('/contact') ?>?package=audit">Minta audit profil gratis dulu →</a></p>
    </div>
</section>
...
<section class="cta-band">
    <div class="cta-inner">
        ...
        <div class="cta-actions">
            ...
            <a href="https://wa.me/6285349362225?text=Halo%20DoubleTap%20Agency%2C%20saya%20ingin%20konsultasi%20gratis" target="_blank" class="btn-secondary btn-large">💬 Chat WhatsApp</a>
        </div>
    </div>
</section>
@endsection
